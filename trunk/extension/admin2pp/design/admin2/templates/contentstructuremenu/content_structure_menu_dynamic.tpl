...
{* See comment in extension/admin2pp/settings/design.ini.append.php <script language="JavaScript" type="text/javascript" src={"javascript/lib/ezjslibimagepreloader.js"|ezdesign}></script>*}
{*{/if}*}
