jQuery(function( $ )
{
    ...
    if ( $('#rightmenu-design').size() == 0 )
    {
        // added this if statement to simulate the fact that
        // this file is included in the default admin2 design
        // only when the page is loaded with the right menu
        return;
    }
